...
<head>
  ...
  <style>
    ...
    .category-hero {
      background: linear-gradient(135deg, rgba(255, 182, 193, 0.9), rgba(255, 233, 244, 0.9));
      border-radius: 32px;
...
<body class="category-view">
  ...
  <main class="page-container">
    <section class="category-hero">
      ...
      <p>Layers of sweetness for birthdays, milestones, and every little victory. Pick the cake that fits your moment.</p>
    </section>

    <?php if (empty($products)): ?>
      <div class="empty-state">No cakes are available right now. Please check again soon.</div>
    <?php else: ?>
