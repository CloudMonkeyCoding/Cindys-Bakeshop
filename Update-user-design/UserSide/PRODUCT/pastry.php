...
$products = [];
if ($pdo) {
    $products = getProductsByCategory($pdo, 'pastry');
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Pastries - Cindy's Bakeshop</title>
  ...
  <style>
    ...
    .category-hero {
      background: linear-gradient(135deg, rgba(255, 229, 180, 0.9), rgba(255, 255, 240, 0.9));
      border-radius: 32px;
...
<body class="category-view">
  ...
  <main class="page-container">
    <section class="category-hero">
      <h1>Pastry indulgence</h1>
      <p>Sweet, flaky, and delightfully buttery—our pastries are perfect for afternoon cravings and coffee companions.</p>
    </section>

    <?php if (empty($products)): ?>
      <div class="empty-state">No pastries available just yet. Fresh batches are on the way!</div>
    <?php else: ?>
